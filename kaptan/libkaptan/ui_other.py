...
class OtherWidget(QWizardPage):
    def __init__(self, parent=None):
        ...
        label.setText(self.tr("<p><strong>Your settings have been applied.</strong> Now you can start enjoying LupuS "
        ...
        groupLabel1.setText(self.tr("<p>Configuration tools for LupuS such as the display, firewall, keyboard, "
                                    "user manager.</p>"))
        ...
        groupLabel2.setText(self.tr("<p>LupuS community, mailing lists, chat rooms, Wiki documents, help and "
                                    "support pages.</p>"))
